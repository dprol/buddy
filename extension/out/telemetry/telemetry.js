    ...
    },
    {
        ...
        fn: (e) => {
            for (const c of e.contentChanges) {
                logger.push(new Logger_1.LoggerEntry(
                    "onDidChangeTextDocument", 
                    "Cambio %s:%s a %s:%s en [%s] reemplazado con: %s`",
                    [
    ...
    // Manejadores de Ventana
    {
        ...
        fn: (editor) => {
            ...
            logger.push(new Logger_1.LoggerEntry(
                ...
                "Editor actual: [%s]; Editor anterior: [%s]",
        ...
        fn: (e) => {
            for (const s of e.selections) {
                ...
                logger.push(new Logger_1.LoggerEntry(
                    ...
                    "Selección %s:%s a %s:%s en [%s] texto: %s",
                    [
    ...
    },
    {
        ...
        fn: (term) => {
            ...
            logger.push(new Logger_1.LoggerEntry(
                ...
                "Terminal actual: [%s]; Terminal anterior: [%s]",
